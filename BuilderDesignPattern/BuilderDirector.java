...
// Director class to encapsulate common request creation logic, and Manages Builder
public class BuilderDirector {
    ...
    // Builder Class only responsible for building HTTPRequest object, we cant
    // create HTTPRequest object directly
    ...
    // Creates common types of HTTP requests , templated methods for common requests
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------");
        HTTPRequest getRequest = HTTPRequestDirector.createGetRequest("http://example.com/api/info");
        getRequest.execute();

        System.out.println("-------------------");
        HTTPRequest postRequest = HTTPRequestDirector.createJsonPostRequest("http://example.com/api/submit","{\"name\":\"John\",\"age\":30}");
        postRequest.execute();
    }
}
